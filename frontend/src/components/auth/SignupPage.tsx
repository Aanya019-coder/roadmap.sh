  ...
  if (success) {
    return (
      <div style={{ width: '100%', maxWidth: 420, textAlign: 'center' }}>
        ...
        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--color-text-primary)', marginBottom: '0.75rem' }}>Check your email</h2>
        <p style={{ color: 'var(--color-text-secondary)', lineHeight: 1.7 }}>
          We sent a verification link to <strong style={{ color: 'var(--color-text-primary)' }}>{email}</strong>.<br />
          Click the link to verify and start your learning journey!
        </p>
        <a href="/login" className="btn btn-primary" style={{ marginTop: '2rem', display: 'inline-flex' }}>Back to Login</a>
      </div>
    );
  }
  ...
  return (
    <div style={{ width: '100%', maxWidth: 420 }}>
      <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
        ...
        <h1 style={{ marginTop: '1.5rem', fontSize: '1.75rem', fontWeight: 700, color: 'var(--color-text-primary)' }}>Create your account</h1>
        <p style={{ marginTop: '0.5rem', color: 'var(--color-text-secondary)', fontSize: '0.9375rem' }}>Get your AI-personalized developer roadmap</p>
      </div>
      ...
      <div style={{ background: 'var(--color-bg-card)', border: '1px solid var(--color-border)', borderRadius: 16, padding: '2rem' }}>
        ...
        <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.875rem', fontWeight: 500, color: 'var(--color-text-secondary)' }}>Full name</label>
...
export function mountSignupPage(el: HTMLElement) {
